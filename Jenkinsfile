pipeline {
    ...
    stages {
       ...
       steps {
                ...
                cp  https://dincric.jfrog.io/artifactory/libs-snapshot-local/org/mybatis/jpetstore/6.0.3-SNAPSHOT  /home/dineshreddy99077/noida/apache-tomcat-7.0.103/webapps/
                '''
